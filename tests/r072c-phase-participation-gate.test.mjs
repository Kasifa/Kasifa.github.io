...
test("retains the R0.72C note and recap after the homepage advances to R0.72I", async () => {
  ...
  assert.match(home, /累计回顾收录 99 个节点/);
...
test("keeps the current manifest and refresh contract synchronized after R0.72I", async () => {

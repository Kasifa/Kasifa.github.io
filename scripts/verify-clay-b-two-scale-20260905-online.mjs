...
const baseUrl = new URL(process.env.CLAY_B_TWO_SCALE_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.CLAY_B_TWO_SCALE_DEPLOYED_COMMIT ?? "unversioned";

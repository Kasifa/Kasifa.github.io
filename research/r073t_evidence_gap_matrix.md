...
| Exact finite diagnostic seal | Final certificate rerun and manifest seal passed `55/55`; source commit `05c55d21f060a17a0a4db04c12e89e7271b03d30`, generated-artifact commit `29d01625731d1c611f927c2852dbddf05967c6cb` | exact package QA | Certifies finite rational reconstruction and package binding only; it is not a continuum proof or a Navier--Stokes simulation | `finiteFormulaDiagnosticValidation=PASS`; `finalSeal=TRUE` |
| Formal figure package | Formal figure QA passed `106/106` over 28 source rows and is bound to the same source/generated-artifact commits | exact package QA | Certifies figure data lineage, hashes, and render checks only; it adds no theorem strength | `formalFigurePackage=PASS`; retain journal-figure provenance with the release |

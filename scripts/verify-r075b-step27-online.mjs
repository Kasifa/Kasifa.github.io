...
const baseUrl = new URL(process.env.R075B_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R075B_DEPLOYED_COMMIT ?? "unversioned";
const sha256 = (bytes) => createHash("sha256").update(bytes).digest("hex");

const objects = [
  ["public/notes/r0-75b.html", "/notes/r0-75b.html"],
  ["public/notes/r0-75b.pdf", "/notes/r0-75b.pdf"],

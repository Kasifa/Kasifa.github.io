...
NOTE_ARTICLE = r'''      <article>
        ...
        <section id="conditioning"><div class="section-no">04 / Conditioning</div><h2>投影、overlap、相位锚和参数导数同时受控</h2><div class="equation result">\[\sup_{\varepsilon,d}\|P_\varepsilon(d)\|<9/5,\qquad \inf_{\varepsilon,d}\operatorname{overlap}>5/9,\qquad \sup_{\varepsilon,d}\|\partial_dP_\varepsilon(d)\|<\infty.\]</div><p>antiunitary 对称与圆内总重数一保证特征值为实数。固定正黏性时，type-A 解析族和 Riesz 公式给出参数解析性与导数界；固定相位锚也持续非零。</p></section>

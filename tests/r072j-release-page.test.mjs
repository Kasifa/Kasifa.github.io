...
test("retains J while synchronizing v1.24, latest K, next L, and archive counts", async () => {
...
test("current shell uses v1.24 while historical J pages retain v1.23", async () => {

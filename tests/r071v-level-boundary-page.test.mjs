...
test("retains R0.71V artifacts while v1.23 publishes R0.72J as current", async () => {
  ...
  assert.match(
    home,
    /<details class="tree-notes" open>[\s\S]*?aria-label="R0\.69P–R0\.72J"/,
  );
  assert.match(home, /href="#r070a">R0\.70A–R0\.72J：62 节已公开，38 节完整封存<\/a>/);

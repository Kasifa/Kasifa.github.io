...
const ENDPOINTS = Object.freeze({
  ...
  r075b: { version: "2.06", code: "R0.75B", slug: "r0-75b", next: "R0.75C" },
  r075c: { version: "2.07", code: "R0.75C", slug: "r0-75c", next: "R0.75D" },
  ...
  r075l: { version: "2.16", code: "R0.75L", slug: "r0-75l", next: "R0.75M" },
  r075m: { version: "2.17", code: "R0.75M", slug: "r0-75m", next: "R0.75N" },
  r075n: { version: "2.18", code: "R0.75N", slug: "r0-75n", next: "R0.75O" },
  r075o: { version: "2.19", code: "R0.75O", slug: "r0-75o", next: "R0.75P" },
  r075p: { version: "2.20", code: "R0.75P", slug: "r0-75p", next: "R0.75Q" },
  r075q: { version: "2.21", code: "R0.75Q", slug: "r0-75q", next: "R0.75R" },
  r075r: { version: "2.22", code: "R0.75R", slug: "r0-75r", next: "R0.75S" },
  r075s: { version: "2.23", code: "R0.75S", slug: "r0-75s", next: "R0.75T" },
  r075t: { version: "2.24", code: "R0.75T", slug: "r0-75t", next: "R0.75U" },
  r075u: { version: "2.25", code: "R0.75U", slug: "r0-75u", next: "R0.75V" },
  r075v: { version: "2.26", code: "R0.75V", slug: "r0-75v", next: "R0.75W" },
  r075w: { version: "2.27", code: "R0.75W", slug: "r0-75w", next: "R0.75X" },
  r075x: { version: "2.28", code: "R0.75X", slug: "r0-75x", next: "R0.75Y" },
  r075y: { version: "2.29", code: "R0.75Y", slug: "r0-75y", next: "R0.75Z" },
  ...
  r076d: { version: "2.34", code: "R0.76D", slug: "r0-76d", next: "R0.76E" },
  r076e: { version: "2.35", code: "R0.76E", slug: "r0-76e", next: "R0.76F" },
  r076f: { version: "2.36", code: "R0.76F", slug: "r0-76f", next: "R0.76G" },
  r076g: { version: "2.37", code: "R0.76G", slug: "r0-76g", next: "R0.76H" },
  r076h: { version: "2.38", code: "R0.76H", slug: "r0-76h", next: "R0.76I" },
  r076i: { version: "2.39", code: "R0.76I", slug: "r0-76i", next: "R0.76J" },
  r076j: { version: "2.40", code: "R0.76J", slug: "r0-76j", next: "R0.76K" },
  r076k: { version: "2.41", code: "R0.76K", slug: "r0-76k", next: "R0.76L" },
  r076l: { version: "2.42", code: "R0.76L", slug: "r0-76l", next: "R0.76M" },
});
...
test("homepage current route reaches the materialized H through R0.74A boundary without duplication", async () => {
  ...
  if (endpoint.release.localeCompare("r074b") >= 0) {
    ...
    assert.ok(home.includes(["r076h", "r076i", "r076j", "r076k", "r076l"].includes(endpoint.release) ? "STOP · NO LATER RELEASE AUTHORIZED" : endpoint.release === "r076f" ? "NEXT · R0.76G" : endpoint.release === "r076e" ? "NEXT · R0.76F" : ["r075f", "r075g", "r075h", "r075i", "r075j", "r075k", "r075l", "r075m", "r075n", "r075o", "r075p", "r075q", "r075r", "r075s", "r075t", "r075u", "r075v", "r075w", "r075x", "r075y", "r075z", "r076a", "r076b", "r076c", "r076d"].includes(endpoint.release) ? "NEXT · NOT AUTHORIZED" : ["r074x", "r074y", "r074z"].includes(endpoint.release) ? `NEXT · ${endpoint.next} FROZEN PACKAGE` : ["r074t", "r074u", "r074w"].includes(endpoint.release) ? "NEXT · FROZEN PACKAGE" : `NEXT · ${endpoint.next}`));
  ...
  assert.ok(isZ
    ...
    : ["r075h", "r075i", "r075j", "r076k", "r076l"].includes(endpoint.release)
...
test("literature route records the materialized H through R0.74A boundary", async () => {
  ...
  assert.ok(topology.includes(["r076h", "r076i", "r076j", "r076k", "r076l"].includes(endpoint.release) ? "开放接口 · 后续版本" : endpoint.release === "r076f" ? "开放接口 · R0.76G" : endpoint.release === "r076e" ? "开放接口 · R0.76F" : ["r075f", "r075g", "r075h", "r075i", "r075j", "r075k", "r075l", "r075m", "r075n", "r075o", "r075p", "r075q", "r075r", "r075s", "r075t", "r075u", "r075v", "r075w", "r075x", "r075y", "r075z", "r076a", "r076b", "r076c", "r076d"].includes(endpoint.release) ? "开放接口 · 后续未授权" : endpoint.release === "r075a" ? "开放接口 · A.63" : ["r074t", "r074u", "r074w", "r074x", "r074y", "r074z"].includes(endpoint.release) ? "开放接口 · 等待冻结包" : `开放接口 · ${endpoint.next}`));
  ...
  if (endpoint.release.localeCompare("r074b") >= 0) {
    ...
    assert.match(boundary, /(?:FINITE|finite|SCOPE|SUFFICIENT ONLY|NOT A BLANKET NO-GO|LIMITED NO-GO|SIGN-DROPPING ONLY)/, `${endpoint.code} boundary finite or sufficient-only scope`);
    return;
  }

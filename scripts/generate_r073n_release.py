...
RELEASE_SOURCE_COMMIT = "8b781137b8e7db8f558601de2076ab910680b60e"
...
def build_note(content: ReleaseContent) -> str:
    ...
    @media(max-width:520px){.table-wrap table{display:table;min-width:760px}article mjx-container[display="true"]{width:100%!important;min-width:0!important;max-width:100%;overflow-x:auto;overflow-y:hidden}}

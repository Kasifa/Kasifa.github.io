...
const baseUrl = new URL(process.env.R075Z_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R075Z_DEPLOYED_COMMIT ?? "unversioned";
const sha256 = (bytes) => createHash("sha256").update(bytes).digest("hex");

const objects = [
  ["public/notes/r0-75z.html", "/notes/r0-75z.html"],
  ["public/notes/r0-75z.pdf", "/notes/r0-75z.pdf"],

...
test("advances the home, literature map, and cumulative recap through R0.71C", async () => {
  ...
  for (const html of [home, literature, recap]) {
    assert.match(html, /src="\/i18n-en\.js\?v=0\.88"/);
  }
});

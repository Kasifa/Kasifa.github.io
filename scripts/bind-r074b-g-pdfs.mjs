...
// Render and bind the queued R0.74B--R0.74G Chinese notes.  This certifies
...
try {
  for (const [release, noteSlug, title] of releases) {
    ...
    const binding = {
      schemaVersion: "r074b-g-synchronized-pdf-binding-v1",
      ...
      claimBoundary: {
        ...
        evidenceClassesSeparated: release === "r074g"
          ? ["PROVED", "FINITE", "OPEN", "ROUTE REJECTED", "NOT CLAY"]
          : ["PROVED", "FINITE", "OPEN", "BOUNDED LITERATURE AUDIT", "NOT CLAY"],

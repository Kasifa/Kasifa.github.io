...
test("maps the complete published route as a branching tree", async () => {
  ...
  assert.ok(route.includes(["R0.75F", "R0.75G", "R0.75H", "R0.75I", "R0.75J", "R0.75K", "R0.75L", "R0.75M", "R0.75N", "R0.75O", "R0.75P", "R0.75Q", "R0.75R", "R0.75S", "R0.75T", "R0.75U", "R0.75V", "R0.75W", "R0.75X"].includes(latestCode) ? "NEXT · NOT AUTHORIZED" : `NEXT · ${nextCode}`));

**Figure R0.72R | A quantitative 1:2:3 core outside the old weighted-jet cone.**
**A,** In the real \((a,b)\) slice of
\(\cos\phi+a\cos2\phi+b\cos3\phi\), the unit-circle degeneracy set consists
of the two endpoint walls and the filtered internal arc
\(a=-2x/(1+4x^2)\), \(b=[3(1+4x^2)]^{-1}\), \(-1\leq x\leq1\).  The real trace of
\(K\) lies outside the old \(4|a|+9|b|\le1/2\) diamond and away from the

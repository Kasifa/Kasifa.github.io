...
row("资料截止：2026-08-28。若后续论文状态、版本或官方判断发生变化，我会在此页更新并保留原来的证据标签。", "Sources checked through 2026-08-28. If a paper's status, version, or an official assessment changes, I will update this page while retaining the original evidence label.");

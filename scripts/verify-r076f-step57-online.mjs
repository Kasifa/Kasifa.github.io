...
const baseUrl = new URL(process.env.R076F_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R076F_DEPLOYED_COMMIT ?? "unversioned";
const sha256 = (bytes) => createHash("sha256").update(bytes).digest("hex");

const objects = [
  ["public/notes/r0-76f.html", "/notes/r0-76f.html"],
  ["public/notes/r0-76f.pdf", "/notes/r0-76f.pdf"],

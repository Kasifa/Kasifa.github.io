...
const baseUrl = new URL(process.env.R075I_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R075I_DEPLOYED_COMMIT ?? "unversioned";
const sha256 = (bytes) => createHash("sha256").update(bytes).digest("hex");

const objects = [
  ["public/notes/r0-75i.html", "/notes/r0-75i.html"],
  ["public/notes/r0-75i.pdf", "/notes/r0-75i.pdf"],

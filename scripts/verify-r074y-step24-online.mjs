...
const baseUrl = new URL(process.env.R074Y_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R074Y_DEPLOYED_COMMIT ?? "unversioned";
const sha256 = (bytes) => createHash("sha256").update(bytes).digest("hex");

const objects = [
  ["public/notes/r0-74y.html", "/notes/r0-74y.html"],
  ["public/notes/r0-74y.pdf", "/notes/r0-74y.pdf"],

...
test("retains R0.72E, its 95-node recap, and bilingual package after R0.72J", async () => {
  const [
    home,
    note,
    recap,
...
test("keeps the current R0.72J site version and split release inventory", async () => {

...
// Local-direct R0.74A translation stage. It never imports a network client or
...
const root = resolve(process.env.R074A_RELEASE_ROOT ?? resolve(import.meta.dirname, ".."));
...
// Reviewed in source order after the R0.74A generate stage. Mathematical and
// URL tokens are copied byte-for-byte so the strict i18n guard can compare
// their ordered protected-token ledgers.
const staleReviewedLocalEnglish = [
  String.raw`Literature review v1.67 · 2036-09-01`,
  ...
  String.raw`R0.74A claim boundary`,
  String.raw`R0.74A: initial-endpoint obstruction, energy repair, and pressure-active separation for positive covariance`,
  String.raw`203 public research notes; latest node R0.74A.`,
  ...
  String.raw`Version R0.74A · 2036-09-01`,
  ...
  String.raw`Research note R0.74A · EXACT ANALYTIC THEOREMS / FINITE CERTIFICATE`,
  ...
  String.raw`Status · R0.74A complete`,
  ...
  String.raw`R0.74A has two reliable increments.`,
  ...
  String.raw`Index of 203 research notes`,
  String.raw`80 sections fully sealed`,
  String.raw`View the full R0.74A card on the homepage`,
  String.raw`Current endpoint R0.74A`,
  String.raw`Jump to the R0.74A homepage card →`,
  ...
  String.raw`Research note R0.74A · 2036-09-01`,
  ...
  String.raw`Read research note R0.74A →`,
  String.raw`Read the latest R0.74A research note →`,
  ...
  String.raw`R0.70A–R0.74A · 105 sections published`,
  String.raw`R0.70A–R0.74A: 105 sections published, 80 fully sealed`,
  String.raw`R0.73Y closed production-only coercivity. R0.74A further proves that D_{ii,s}^{3/2} can diverge at the energy-class initial trace and establishes D_{ii,s}√k_s as a positive cubic repair paid by Leray energy. The crossed pressure-active exact family shows that local pressure debt still requires separate settlement. NOT CLAY.`,
  String.raw`R0.74A closes energy-class initial-endpoint finiteness for D_{ii,s}^{3/2} negatively and supplies D_{ii,s}√k_s as a positive cubic repair paid by Leray energy. Next, only the local upper payment for K_D and pressure-cutoff debt are addressed; quotient coercivity, epsilon regularity, arbitrary three-dimensional global regularity, and Clay remain OPEN.`,
  String.raw`R0.74A: initial-endpoint finiteness obstruction, energy-compatible positive cubic repair, and pressure-active separation`,
  String.raw`R0.74A | Finiteness obstruction for a positive cubic heat covariance and an energy-compatible repair`,
  String.raw`R0.74A next interface`,
];

const reviewedLocalEnglishHomeFirst = [
  String.raw`Index of 203 research notes`,
  String.raw`81 sections fully sealed`,
  String.raw`View the full R0.74A card on the homepage`,
  String.raw`Current endpoint R0.74A`,
  String.raw`The old R0.73X exterior package alone does not control \(\mathcal K_D\). The new velocity endpoint tail and the reused gradient tail are finite for every stated energy-class field, but they are not yet proved small, absorbable, or controlled by a smaller cylinder.`,
  String.raw`The positive four-block majorization separates core--core, core--exterior, exterior--core, and exterior--exterior; the corresponding payments carry \(\theta^{1/4}\) or \(\theta\).`,
  String.raw`The positive four-block majorization assigns core--core to clock-matched local energy and the other three blocks to explicit Gaussian velocity/gradient tails. The old R0.73X exterior package is insufficient by itself; the new tails are proved finite, not small, absorbable, or compact. NOT CLAY.`,
  String.raw`Jump to the R0.74A homepage card →`,
  String.raw`Next publication gate (R0.74B):`,
  String.raw`The next section asks only whether the new velocity endpoint tail and the reused gradient tail can be controlled or absorbed by data from a smaller cylinder, or replaced by a weakly stable coupled tail along a suitable-weak blow-up sequence. First test the time-supremum obstruction, lower semicontinuity, and scale uniformity. Record any failure as an exact counterexample and do not propose quotient coercivity before tail payment closes.`,
  String.raw`Research note R0.74A · 2026-09-01`,
  String.raw`Read research note R0.74A →`,
  String.raw`Read the latest R0.74A research note →`,
  String.raw`Expand 113 published notes`,
  String.raw`Review v1.67 · 2026-09-01`,
  String.raw`The cumulative review after the R0.60 recap contains 140 nodes; the site now has 203 public research notes`,
  String.raw`R0.70A–R0.74A · 105 sections published`,
  String.raw`R0.70A–R0.74A: 105 sections published, 81 fully sealed`,
  String.raw`R0.74A splits the positive-scale upper bound for the mixed heat covariance into four exact blocks: local energy pays the core, and two explicit Gaussian tails pay the exterior. The old exterior package is insufficient by itself; tail absorption and epsilon regularity remain open. NOT CLAY.`,
  String.raw`R0.74A splits the positive-scale local upper bound for K_D into core--core and three exterior blocks. Clock-matched local energy pays the former; a new velocity endpoint tail and the R0.73X gradient tail pay the latter. The next step asks only whether these tails are small, absorbable, or weakly stable. Quotient coercivity, epsilon regularity, arbitrary three-dimensional global regularity, and Clay remain OPEN.`,
  String.raw`R0.74A: core/exterior four-block payments, explicit Gaussian tails, and the old-package obstruction are now separated`,
  String.raw`R0.74A | A localized size lemma for the mixed heat covariance`,
  String.raw`R0.74B next interface`,
  String.raw`Open interface · R0.74B`,
  String.raw`Literature review v1.67 · 2026-09-01`,
  String.raw`I list published theorems as known results, mark 2026 preprints separately, and present R0.69P–R0.74A only as research notes. I do not extrapolate computations or notes into regularity theorems.`,
  String.raw`Read the R0.74A research note`,
  String.raw`Core/exterior four-block payments, explicit Gaussian velocity/gradient tails, and the obstruction to the old exterior package are recorded separately.`,
  String.raw`The positive majorization separates core--core, core--exterior, exterior--core, and exterior--exterior. Clock-matched local energy pays the first block, while a new velocity endpoint tail and the R0.73X gradient tail pay the other three. Two exact energy-class packets show that the old exterior package is insufficient by itself.`,
  String.raw`R0.70A–R0.74A: 105 sections published, 81 fully sealed.`,
  String.raw`R0.74A claim boundary`,
  String.raw`R0.74A: core/exterior four-block size lemma for the mixed heat covariance`,
  String.raw`203 public research notes; latest node R0.74A.`,
  String.raw`A localized size lemma for the mixed heat covariance`,
  String.raw`Research-note index · v1.67 · 2026-09-01`,
  String.raw`Latest node R0.74A · continuously revised`,
  String.raw`Version R0.74A · 2026-09-01`,
  String.raw`This section proves only a positive-scale size lemma: clock-matched local energy pays core--core, while explicit exterior velocity/gradient tails pay the other three blocks. It does not prove that the tails are small, absorbable, or compact, nor does it prove epsilon regularity, singularity formation, or arbitrary three-dimensional global regularity. NOT CLAY.`,
  String.raw`Four-block payments, the old exterior-package obstruction, and the time-supremum tail`,
  String.raw`The positive four-block majorization gives \(\theta^{1/4}\) or \(\theta\) payments. The old R0.73X exterior package is insufficient by itself; the new velocity endpoint tail and the reused gradient tail are only proved finite, not small or absorbable.`,
  String.raw`The 266 rows only recompute proved formulas and two function-level obstruction ledgers. They are not DNS, an NSE trajectory, a singularity candidate, or proof by finite sampling. NOT CLAY.`,
  String.raw`Research note R0.74A · EXACT ANALYTIC SIZE LEMMA / FINITE CERTIFICATE`,
  String.raw`Finite arithmetic certificate report`,
  String.raw`Status · R0.74A complete`,
  String.raw`The core is paid by local energy and the exterior by two explicit Gaussian quadratic tails`,
];

// collectSiteStrings uses absolute publication paths in this release stage, so
// its deterministic order is literature, note index, note, then homepage.
...
if (mode === "--capture-missing") {
  if (reviewedLocalEnglish.length !== missing.length) {
    throw new Error(`reviewed R0.74A translation ledger has ${reviewedLocalEnglish.length} rows for ${missing.length} missing strings`);
  }
  const snapshot = missing.map((entry, index) => ({
    zh: entry.zh,
    en: reviewedLocalEnglish[index],
    sourceIdAtCapture: `r074a${String(index + 1).padStart(3, "0")}`,
    capturedEnglishSha256: sha256(reviewedLocalEnglish[index]),
    provenance: "local-direct-reviewed",
    reasonCodes: ["R074A_RELEASE_BATCH"],
  ...
  console.log(JSON.stringify({ captured: snapshot.length, snapshot: "scripts/i18n-snapshots/r074a-missing.json", translationPath: "LOCAL_DIRECT_NO_DGX", dgxUsed: false }));
  process.exit(0);
}
...
for (const token of ["R0.74A", "NOT CLAY", "LOCAL_DIRECT_NO_DGX"]) {

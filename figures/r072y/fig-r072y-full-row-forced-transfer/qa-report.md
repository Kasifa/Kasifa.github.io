...
- liftUpFormulaRecomputed: PASS
- ratePowersRecomputed: PASS
- allLiftUpSeriesShowStrictGrowth: PASS
- positiveXiCounterexamplesPresent: PASS
- noFittedExponents: PASS
- muPositiveBoundaryVisible: PASS
- openBoundaryVisible: PASS
- falseBoundaryVisible: PASS
- counterexampleBoundaryVisible: PASS
- rateBoundaryVisible: PASS

#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Import the frozen ClayB-LaggedPressureReduction package from committed bytes."""
...
SOURCE_COMMIT = "891e6b85f53ae19272973c191726f1278e47918b"
BASE_COMMIT = "299a3b4e7deab8f561c83559c13741aaa5137343"
FREEZE_COMMIT = "3501cf9d70cbb5140186bb18d0cf1da8c110480f"
RELEASE_ID = "ClayB-LaggedPressureReduction-20260906"
MANIFEST_PATH = "research/clay_b_lagged_pressure_release_20260906.json"
MANIFEST_HASH = "14ee88415128d1ca4dd65648efb8a1168815d1264f16e24f8d264aa07d5d6dfd"
CHECK_ONLY = "--check-only" in sys.argv[1:]
LEDGER = ROOT / "research/clay_b_lagged_pressure_frozen_ledger_20260906.json"
...
if manifest["logical_predecessor"] != "ClayB-PressureTestCoupling-20260906":
...
if len(manifest["files"]) != 10 or len(manifest["dependencies"]) != 41:
...
if formula_tags != 98 or len(rows) != 51:
...
ledger = {
    "schemaVersion": "clay-b-lagged-pressure-portable-ledger-v1",
...
print(json.dumps({
    "schemaVersion": "clay-b-lagged-pressure-frozen-import-v1",
    "releaseId": RELEASE_ID,
    "status": "PASS",

#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Import the frozen ClayB-RecentSourceScreen package from committed bytes."""
...
SOURCE_COMMIT = "5314045dcedcc7e781d9fed0f167cae5c0451d62"
BASE_COMMIT = "2b7cfe590decf90aea2326e9b76bc04bcf345e0b"
FREEZE_COMMIT = "9b556d81330a93f274372ed2e3be262e4be37d98"
RELEASE_ID = "ClayB-RecentSourceScreen-20260906"
MANIFEST_PATH = "research/clay_b_recent_source_screen_release_20260906.json"
MANIFEST_HASH = "d15d3bb15e8481c5f389c562665b374c2f7a16139eb1f32029b8ed6b0381102b"
CHECK_ONLY = "--check-only" in sys.argv[1:]
LEDGER = ROOT / "research/clay_b_recent_source_screen_frozen_ledger_20260906.json"
...
if manifest["logical_predecessor"] != "ClayB-LaggedPressureReduction-20260906":
...
if manifest["status"] != "research-frozen" or digest(manifest_bytes) != MANIFEST_HASH:
    raise RuntimeError("frozen manifest status or hash drift")
if len(manifest["files"]) != 9 or len(manifest["dependencies"]) != 56:
...
if formula_tags != 57 or len(rows) != 65:
...
ledger = {
    "schemaVersion": "clay-b-recent-source-screen-portable-ledger-v1",
...
print(json.dumps({
    "schemaVersion": "clay-b-recent-source-screen-frozen-import-v1",
    "releaseId": RELEASE_ID,
    "status": "PASS",

  ...
  <main>
    <header class="hero"><div class="hero-inner">
      <div>
        ...
        <p class="lead">R0.71S 的缩放结论只覆盖初始 observation face。本节对同一 Fourier seed 做有限壳预补偿：标准局部 NSE 流映射与有限维隐函数定理把整个目标壳在预定正时间精确压到零，而 nonlinear Lamb forcing 仍非零。该零点是严格内部、simple、positive。随后取振幅 \(a_\lambda=\lambda^{-2}\) 再作 NSE 协变缩放，entry 原子按 λ⁻⁴、裸 normalized Leray-Lamb 时间预算按 λ⁻⁶，最优常数至少按 λ² 发散；初始能量与临界范数同时趋零。</p>
      </div>
    ...
    <div class="layout">
      ...
      <article>
        ...
        <section id="construction"><div class="section-no">01 / Positive-time construction</div><h2>只改初始目标壳，在预定正时间把整个壳精确压到零</h2>
          ...
          <div class="equation result">\[
            D_z\Phi(0,0)=e^{-2\nu\tau}I.
          \]</div>
          <p>该有限矩阵可逆，隐函数定理给出真实修正 \(z(a)\)，使目标壳在 τ 精确为零。二次 Duhamel 展开同时给出</p>
          <div class="equation result">\[
        ...
        <section id="claims"><div class="section-no">10 / Claim boundary</div><h2>本节证明什么，也明确不证明什么</h2>
          <ul>
            <li><strong>已证明：</strong>真实 smooth positive-time full-shell internal entry；至少一个 induced local positive cell；global positive entry 自动 simple；bounded-energy/enstrophy internal scaling no-go；finite outgoing-coarea identity；finite conditional trace-variation theorem。</li>

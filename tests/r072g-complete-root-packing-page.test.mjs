...
test("synchronizes v1.22 counts, inventory, latest gate, and next release", async () => {
  ...
  assert.match(home, /recap-r0-61-r0-72i\.html/);
  ...
  assert.equal(archive.latestPublishedRelease, "r072i");

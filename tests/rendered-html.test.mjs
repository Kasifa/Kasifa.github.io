...
test("maps the complete published route as a branching tree through R0.71B", async () => {
  ...
  const later = [
    ...
    ...Array.from(
      { length: 26 },
      (_, index) => `/notes/r0-70${String.fromCharCode(97 + index)}.html`,
    ),
    "/notes/r0-71a.html",
    "/notes/r0-71b.html",
  ];
...
test("publishes and links the Leray polarization-channel theorem and normal obstruction", async () => {
  ...
  assert.match(home, /<strong>v0\.87<\/strong>网页版本/);

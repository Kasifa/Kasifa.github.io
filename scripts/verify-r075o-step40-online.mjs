...
const baseUrl = new URL(process.env.R075O_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R075O_DEPLOYED_COMMIT ?? "unversioned";
const sha256 = (bytes) => createHash("sha256").update(bytes).digest("hex");

const objects = [
  ["public/notes/r0-75o.html", "/notes/r0-75o.html"],
  ["public/notes/r0-75o.pdf", "/notes/r0-75o.pdf"],

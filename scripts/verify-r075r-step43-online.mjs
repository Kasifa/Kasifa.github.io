...
const baseUrl = new URL(process.env.R075R_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R075R_DEPLOYED_COMMIT ?? "unversioned";
const sha256 = (bytes) => createHash("sha256").update(bytes).digest("hex");

const objects = [
  ["public/notes/r0-75r.html", "/notes/r0-75r.html"],
  ["public/notes/r0-75r.pdf", "/notes/r0-75r.pdf"],

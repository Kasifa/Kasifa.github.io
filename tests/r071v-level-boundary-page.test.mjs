...
test("retains R0.71V artifacts while v1.21 publishes R0.72H as current", async () => {
  ...
  assert.match(
    home,
    /<details class="tree-notes" open>[\s\S]*?aria-label="R0\.69P–R0\.72H"/,
  );
  assert.match(home, /href="#r070a">R0\.70A–R0\.72H：60 节已公开，36 节完整封存<\/a>/);

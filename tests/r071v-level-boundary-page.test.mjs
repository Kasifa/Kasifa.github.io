...
test("retains R0.71V artifacts while v1.18 publishes R0.72E as current", async () => {
  ...
  assert.match(
    home,
    /<details class="tree-notes" open>[\s\S]*?aria-label="R0\.69P–R0\.72E"/,
  );
  assert.match(home, /href="#r070a">R0\.70A–R0\.72E 已公开并封存版本<\/a>/);

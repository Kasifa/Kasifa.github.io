...
const baseUrl = new URL(process.env.R074V_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R074V_DEPLOYED_COMMIT ?? "unversioned";
const sha256 = (bytes) => createHash("sha256").update(bytes).digest("hex");

const objects = [
  ["public/notes/r0-74v.html", "/notes/r0-74v.html"],
  ["public/notes/r0-74v.pdf", "/notes/r0-74v.pdf"],

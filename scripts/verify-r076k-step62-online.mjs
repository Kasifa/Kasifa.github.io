...
const baseUrl = new URL(process.env.R076K_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R076K_DEPLOYED_COMMIT ?? "unversioned";
...
console.log(JSON.stringify({ status: failures.length === 0 ? "PASS" : "FAIL", release: "R0.76K Step 62", baseUrl: baseUrl.href, commit, objectCount: results.length, exactCount: results.length - failures.length, results, failures }, null, 2));

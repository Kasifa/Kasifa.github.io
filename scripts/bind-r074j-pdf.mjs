...
// Render and bind the complete Chinese R0.74J note. This certifies publication
...
const release = "r074j";
const noteSlug = "r0-74j";
const title = "R0.74J｜第五支付壳给出的匹配完整支付律";
...
try {
  ...
  if (structure.title !== title) throw new Error("R0.74J PDF title drift");
  ...
  ) throw new Error("R0.74J render provenance mismatch");

  const binding = {
    schemaVersion: "r074j-synchronized-pdf-binding-v1",
    release: "R0.74J",

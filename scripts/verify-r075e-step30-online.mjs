...
const baseUrl = new URL(process.env.R075E_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R075E_DEPLOYED_COMMIT ?? "unversioned";
const sha256 = (bytes) => createHash("sha256").update(bytes).digest("hex");

const objects = [
  ["public/notes/r0-75e.html", "/notes/r0-75e.html"],
  ["public/notes/r0-75e.pdf", "/notes/r0-75e.pdf"],

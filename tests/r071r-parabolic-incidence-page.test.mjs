...
test("keeps historical R0.71R artifacts while v1.21 publishes R0.72H as current", async () => {
  ...
  assert.equal(occurrenceCount(currentRoute[1], 'href="/notes/'), 68);
...
test("ships one R0.71R release card and the complete reader-facing package", async () => {
  ...
  for (const token of [
    ...
    "figures/r071r-parabolic-incidence/fig-r071r-parabolic-incidence",
    'href="/recap-r0-61-r0-72h.html"',
    'href="/recap-r0-61-r0-72h.pdf"',
  ]) {

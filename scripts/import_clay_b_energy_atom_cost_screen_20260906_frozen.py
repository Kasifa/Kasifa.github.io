#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Import the frozen ClayB-EnergyAtomCostScreen package from committed bytes."""
...
SOURCE_COMMIT = "7567e791fa3170bc71551c817cecc50b663d4d65"
BASE_COMMIT = "11f6e30c0f181d9b590303e47d41f902b3046009"
FREEZE_COMMIT = "ccad47d0ed3549d1d1bf75d9b18ace5647fd1d96"
RELEASE_ID = "ClayB-EnergyAtomCostScreen-20260906"
MANIFEST_PATH = "research/clay_b_energy_atom_cost_screen_release_20260906.json"
MANIFEST_HASH = "d63a17b488c5098874b1fc3e42735f10d39c71b5c25ea0e13da9766b63d8f6b7"
CHECK_ONLY = "--check-only" in sys.argv[1:]
LEDGER = ROOT / "research/clay_b_energy_atom_cost_screen_frozen_ledger_20260906.json"
...
if manifest["logical_predecessor"] != "ClayB-EulerCompactnessScreen-20260906":
...
if len(manifest["files"]) != 6 or len(manifest["dependencies"]) != 109:
...
if formula_tags != 18 or len(rows) != 115:
...
ledger = {
    "schemaVersion": "clay-b-energy-atom-cost-screen-portable-ledger-v1",
...
print(json.dumps({
    "schemaVersion": "clay-b-energy-atom-cost-screen-frozen-import-v1", "releaseId": RELEASE_ID,

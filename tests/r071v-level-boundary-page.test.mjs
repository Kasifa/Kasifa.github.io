...
test("retains R0.71V artifacts while v1.24 publishes R0.72K as current", async () => {
  ...
  assert.match(
    home,
    /<details class="tree-notes" open>[\s\S]*?aria-label="R0\.69P–R0\.72K"/,
  );
  assert.match(home, /href="#r070a">R0\.70A–R0\.72K：63 节已公开，39 节完整封存<\/a>/);

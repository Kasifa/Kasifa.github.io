#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Import the frozen ClayB-FixedHistoryScreen package from committed bytes."""
...
SOURCE_COMMIT = "67476e7a2e236af9c3ce50ca95f8925f032d5704"
BASE_COMMIT = "56027d0cf173535de10a67865e91fa019fbef332"
FREEZE_COMMIT = "20a2abc781ad6784f552d2a80211298e5711c97f"
RELEASE_ID = "ClayB-FixedHistoryScreen-20260906"
MANIFEST_PATH = "research/clay_b_fixed_history_screen_release_20260906.json"
MANIFEST_HASH = "73ac9094f3786b82a2d4ea6597717bf2f43733f0caf0b089359c30330abb5407"
CHECK_ONLY = "--check-only" in sys.argv[1:]
LEDGER = ROOT / "research/clay_b_fixed_history_screen_frozen_ledger_20260906.json"
...
if manifest["logical_predecessor"] != "ClayB-AncientConstantScreen-20260906":
...
if len(manifest["files"]) != 7 or len(manifest["dependencies"]) != 82:
...
if formula_tags != 52 or len(rows) != 89:
...
ledger = {
    "schemaVersion": "clay-b-fixed-history-screen-portable-ledger-v1",
    ...
    "affineCoefficientPairCount": manifest["qa"]["affine_coefficient_pairs"],
...
print(json.dumps({
    "schemaVersion": "clay-b-fixed-history-screen-frozen-import-v1",
    "releaseId": RELEASE_ID,
    "status": "PASS",

...
The 21 figure source/raw artifacts are byte-identical to immutable commit `176ceaa79fb2ffb26ddf6b23080532ec6a8109c8` and their exact scoped Git status is clean.  This is the formal figure-source seal; only the four metadata files are left for the separate reseal commit.  `dgxUsed=false`; `NOT CLAY`.

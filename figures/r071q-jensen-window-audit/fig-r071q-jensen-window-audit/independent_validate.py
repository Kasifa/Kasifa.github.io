#!/usr/bin/env python3
"""Independent asset and CSV validation for the R0.71Q figure."""
...
def main() -> None:
    ...
    for token in ("Complex-time radius", "Anchor logarithm", "union of zero sets", "Local analytic data"):
    ...
    result = {
        ...
        "method": "standalone CSV/PDF/SVG/PNG inspection using csv, Pillow, and pypdf",
        "checks": checks,
    }

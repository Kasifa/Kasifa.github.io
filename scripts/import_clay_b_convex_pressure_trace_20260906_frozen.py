#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Import the frozen ClayB-ConvexPressureTrace package from committed bytes."""
...
SOURCE_COMMIT = "1cd4679f91661ece2b3d55ae16d45ba980094344"
BASE_COMMIT = "a1dc8ad6a9a5b50f6a9fd63c482538d863583c77"
FREEZE_COMMIT = "148dc22795632524c303231ec000b1a239da192a"
RELEASE_ID = "ClayB-ConvexPressureTrace-20260906"
MANIFEST_PATH = "research/clay_b_convex_pressure_trace_release_20260906.json"
MANIFEST_HASH = "881c25b4df6ea3d256479b4c2f88ddefe15141f8867afb068b9364b904a36937"
CHECK_ONLY = "--check-only" in sys.argv[1:]
LEDGER = ROOT / "research/clay_b_convex_pressure_trace_frozen_ledger_20260906.json"
...
if manifest["logical_predecessor"] != "ClayB-AdjointWeakTraceScreen-20260906":
...
if len(manifest["files"]) != 6 or len(manifest["dependencies"]) != 136:
...
if formula_tags != 22 or len(rows) != 142 or len({row["path"] for row in rows}) != 142:
...
ledger = {
    "schemaVersion": "clay-b-convex-pressure-trace-portable-ledger-v1",
...
print(json.dumps({
    "schemaVersion": "clay-b-convex-pressure-trace-frozen-import-v1",
    "releaseId": RELEASE_ID,
    "status": "PASS",

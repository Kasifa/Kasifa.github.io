...
const baseUrl = new URL(process.env.R075S_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R075S_DEPLOYED_COMMIT ?? "unversioned";
const sha256 = (bytes) => createHash("sha256").update(bytes).digest("hex");

const objects = [
  ["public/notes/r0-75s.html", "/notes/r0-75s.html"],
  ["public/notes/r0-75s.pdf", "/notes/r0-75s.pdf"],

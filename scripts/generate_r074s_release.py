...
RELEASE = "r074s"
CODE = "R0.74S"
TITLE = "R0.74S｜canonical best-N last-exit 等价与 no-gain"
...
<title>{TITLE}</title><meta name="description" content="canonical best-N last exits 与 terminal tails 的精确等价，以及 completed-clock algebra 的 no-gain 边界">
...
<body><nav class="top"><a href="/research-review.html">研究首页</a><span>R0.74S · 2026-09-03</span></nav><main><header class="hero"><div class="hero-inner"><div><div class="section-no">研究笔记 R0.74S · 完整中文版本</div><h1>{TITLE}</h1><p>\\(F\\)-half-exit 精确等于二分之一 signed best-\\(N\\) tail；\\(K\\)-last-exit 只在一个尖锐 \\(B_Q\\) 误差内等价。<strong>CANONICAL STOPS GIVE NO NEW QUADRATIC COMPRESSION. NOT CLAY.</strong></p><div class="labels"><span class="label">PROVED</span><span class="label">EXACT REPRESENTATION</span><span class="label">NO-GAIN</span><span class="label">S.38 RETAINED</span><span class="label">FINITE AUDIT</span><span class="label">NOT CLAY</span></div></div><div class="stamp"><strong>状态 · R0.74S STEP 9</strong><p>S.200–S.222：PROVED</p><p>F-half-exit：EXACT 1/2 TAIL</p><p>K-last-exit：WITHIN SHARP B_Q</p><p>S.25 for F-half-exit：FALSE</p><p>theta&lt;3/4 closure：FINITE / GOOD TERMINALS</p><p>canonical compression：NO-GAIN</p><p>full Q.12 PDE tail：OPEN</p><p>S.38：RETAINED</p><p>Q.1 / regularity：OPEN</p><p>无仿真 / NO DGX</p></div></div></header><article>
{report_body()}
<section id="figure"><div class="section-no">F / 期刊主图</div><h2>canonical half-exit、last-exit 与 best-N tail 的 no-gain 等价</h2><picture><source srcset="/assets/r074s/{FIGURE_ID}.svg" type="image/svg+xml"><img src="/assets/r074s/{FIGURE_ID}.png" alt="R0.74S canonical best-N last-exit equivalence and no-gain"></picture><p><a href="/assets/r074s/{FIGURE_ID}.pdf">矢量 PDF</a> · <a href="/assets/r074s/{FIGURE_ID}.png">600 dpi PNG</a> · <a href="/assets/r074s/{FIGURE_ID}.svg">SVG</a> · <a href="/figures/r074s/{FIGURE_ID}/source-data.csv">source data</a> · <a href="/figures/r074s/{FIGURE_ID}/qa-report.md">视觉 QA</a></p><p class="note">已完成 clock algebra 的精确表示与 no-gain 结论；不是新 PDE packing、DNS、奇点或正则性证据。</p></section>
<section id="reproduce"><div class="section-no">R / 冻结证据</div><h2>解析主文、证书与独立审计</h2><p class="files"><a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_problem_freeze.md">问题冻结</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_dissipation_rayleigh_gate.md">Step 7 主文</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_defect_relaxed_total_rayleigh_excess.md">Step 8 主文</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_best_n_last_exit_equivalence.md">Step 9 最终解析主文</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_best_n_last_exit_primary_audit.md">Step 9 主审计</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_best_n_last_exit_independent_audit.md">Step 9 独立审计</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_best_n_last_exit_certificate.json">Step 9 机器证书 JSON</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_best_n_last_exit_certificate_report.md">Step 9 证书报告</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_claim_state_update.md">主张边界</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_literature_boundary.md">文献边界</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_report-source.md">中文 reader source</a></p><p><a href="/notes/r0-74s.pdf">同步研究笔记 PDF</a> · <a href="/recap-r0-61-r0-74o.html">上一大里程碑 recap（截止 R0.74O，157 节）</a> · <a href="/recap-r0-61-r0-74o.pdf">PDF</a></p><p class="note">Step 9：Python 9/9 exact、8/8 finite、57/57 structural、18/18 mutations；Ruby 12/12 groups、91,396/91,396 finite cases、49/49 structural、21/21 source mutations、15/15 artifact mutations、6/6 report checks。有限证书不替代 PDE 解析证明。</p></section>
<section id="next"><div class="section-no">NEXT / 下一门槛</div><h2 style="margin:.35rem 0 .15rem;font-size:1.15rem">R0.74T</h2><p style="margin:.15rem 0">定义并审计删去 Step 7 low-Rayleigh 与 Step 8 \\(\\mathcal I_\\beta/\\mathcal I_\\sigma\\) 已付分支后的 forced PDE residual tail；至多 \\(N_0\\) 个 terminal-dependent exceptions 由 \\(\\sqrt{{N_0}}Z_R\\) 支付。</p></section></article></main></body></html>'''
...
def update_home() -> None:
    ...
    pairs = (
        ('data-site-version="1.87"', 'data-site-version="1.88"', "home version"),
        ('/i18n-en.js?v=1.87', '/i18n-en.js?v=1.88', "home i18n"),
        ('/site-refresh.js?v=1.87.1', '/site-refresh.js?v=1.88.1', "home refresh"),
        ('<strong>v1.87</strong>网页版本', '<strong>v1.88</strong>网页版本', "home stat version"),
        ('<h3>R0.74S：no-exception stopped-work 二次界 no-go</h3>', '<h3>R0.74S：canonical best-N last-exit 等价与 no-gain</h3>', "current route title"),
        ('<p class="tree-current-summary">no-exception stopped work 与 full terminal positive flux 只差已付 B_Q；smooth exact family 严格否定普适二次界。S.38 保留，下一步转向 fixed best-N terminal exceptions。NOT CLAY。</p>', '<p class="tree-current-summary">F-half-exit 精确等于二分之一 signed best-N tail；K-last-exit 只在尖锐 B_Q 内等价。canonical stops 不产生新二次压缩。NOT CLAY。</p>', "current route summary"),
        ('<p class="tree-path">low-Rayleigh payment → total-Rayleigh excess → B_Q-precision equivalence → exact NSE no-go → fixed best-N exceptions</p>', '<p class="tree-path">no-exception no-go → signed half-exit → K-last-exit → sharp B_Q equivalence → paid-branch residual tail</p>', "current route path"),
        ('综述 v1.87 · 2026-09-02', '综述 v1.88 · 2026-09-03', "footer"),
    )
    for old, new, label in pairs:
        page = replace_once_or_present(page, old, new, label)
    page, count = re.subn(r'<div class="summary-item"><strong>我目前关注</strong><span>.*?</span></div>', '<div class="summary-item"><strong>我目前关注</strong><span>R0.74S Step 9 已证明 canonical best-N last exits 只是终端尾的精确表示，不产生新二次压缩。下一门槛是删去 Step 7/8 已付分支后的 forced PDE residual tail。</span></div>', page, count=1, flags=re.S)
    if count != 1:
        raise RuntimeError("home focus replacement failed")
    latest = '''<section class="route-overview latest-release-spotlight" id="latest-release" aria-labelledby="latest-release-title"><div class="route-overview-inner"><header class="route-map-header"><div><p class="eyebrow">LATEST RELEASE · R0.74S · 2026-09-03</p><h2 class="route-map-title" id="latest-release-title">R0.74S｜canonical best-N last-exit 等价与 no-gain</h2><p class="route-map-intro">F-half-exit = 1/2 signed best-N tail；K-last-exit 在尖锐 B_Q 误差内等价。canonical stops 无新二次压缩。NOT CLAY。</p></div><nav class="route-map-actions" aria-label="最新发布快捷入口"><a class="route-map-latest" href="/notes/r0-74s.pdf">阅读最新 R0.74S 研究笔记 →</a><a href="/assets/r074s/fig-r074s-ball-clock-debt.pdf">期刊主图</a><a href="/recap-r0-61-r0-74o.html">最新大里程碑 recap（R0.61–R0.74O，157 节）</a><a href="/notes/">221 篇研究笔记总索引</a><a href="#r074s">查看首页 R0.74S 卡片</a></nav></header><div class="route-legend" aria-label="最新发布计数"><span><i class="route-legend-mark kept" aria-hidden="true"></i>R0.70A–R0.74S · 123 节已公开</span><span><i class="route-legend-mark kept" aria-hidden="true"></i>98 节完整封存</span><span><i class="route-legend-mark current" aria-hidden="true"></i>当前端点 R0.74S</span></div></div></section>'''
    ...
    old_next = '<div class="tree-row"><article class="tree-node next"><div class="tree-node-head"><span class="route-range">NEXT · R0.74T</span><span class="tree-state current">下一检查点</span></div><h3>R0.74T 下一接口</h3><p>回到 fixed best-N、terminal-dependent exceptions，并用 sqrt(N)Y2 支付尾部；不再尝试 no-exception supremum。</p></article></div>'
...
def update_literature() -> None:
    ...
    for old, new, label in (
        ('data-site-version="1.87"', 'data-site-version="1.88"', "lit version"), ('/i18n-en.js?v=1.87', '/i18n-en.js?v=1.88', "lit i18n"), ('文献综述 v1.87 · 2026-09-02', '文献综述 v1.88 · 2026-09-03', "lit footer"),
    ):
        page = replace_once_or_present(page, old, new, label)
    old = '<div class="route-step kept"><header><b>R0.74S</b><strong>no-exception stopped work 的 B_Q-精度等价与 exact NSE no-go</strong></header><p>S.163–S.196 建立 total-Rayleigh excess interface；S.197–S.198 证明 W_up 与 full terminal flux 只差已付 B_Q；S.199 用 smooth exact family 严格否定普适 no-exception 二次界。S.38 条件蕴含保留。<a href="/notes/r0-74s.html">研究笔记</a> <a href="#r074s-boundary">主张边界</a></p></div><div class="route-step pause"><header><b>开放接口 · R0.74T</b><strong>fixed best-N terminal exceptions</strong></header><p>回到 R0.74Q 的 terminal-dependent exception quantifier，并用 sqrt(N)Y2 支付尾部。</p></div>'
    new = '<div class="route-step kept"><header><b>R0.74S</b><strong>canonical best-N last-exit 等价与 no-gain</strong></header><p>S.200–S.207 给出 signed half-exit 精确表示；S.210–S.214 给出 K-last-exit 的尖锐一个 B_Q 比较；S.218 证明 canonical stops 与既有 best-N tail 等价，不产生新二次压缩。<a href="/notes/r0-74s.html">研究笔记</a> <a href="#r074s-boundary">主张边界</a></p></div><div class="route-step pause"><header><b>开放接口 · R0.74T</b><strong>paid-branch residual tail</strong></header><p>删去 Step 7 low-Rayleigh 与 Step 8 I_beta/I_sigma 已付分支后，定义并审计 forced PDE residual tail。</p></div>'
    page = replace_once_or_present(page, old, new, "literature route")
    boundary = '<h3 id="r074s-boundary">R0.74S 的文献与主张边界</h3><p>Step 9 在继承的 completed-clock algebra 上建立 canonical last-exit 表示；不声称新颖性、优先权或新 PDE packing theorem。</p><div class="boundary"><strong>R0.74S Step 9 公开边界</strong><p>PROVED：W_half=(1/2)S_N^F；W_theta^K 与 (1−theta)S_N^K 只差尖锐 B_Q；theta&lt;3/4 的有限 positive-terminal good-stop closure；full Q.12 与更弱 plateau restriction 的区分；canonical last exits 的 no-gain 等价。FALSE：F-half-exit 自动满足 S.25。RETAINED：Step 8 no-exception no-go 与 S.38 条件蕴含。FINITE：Python 9/9、8/8、57/57、18/18；Ruby 12/12 groups、91,396/91,396 cases、49/49 structural、21/21 source mutations、15/15 artifact mutations、6/6 report checks。OPEN：删去已付分支后的 forced PDE residual tail、fixed N0 tail bound、Q.1 与正则性。<strong>NOT CLAY.</strong> <a href="/notes/r0-74s.html">阅读完整中文笔记</a>。</p></div>\n'
...
def update_notes_index() -> None:
    ...
    for old, new, label in (
        ('data-site-version="1.87"', 'data-site-version="1.88"', "index version"), ('/i18n-en.js?v=1.87', '/i18n-en.js?v=1.88', "index i18n"), ('/site-refresh.js?v=1.87', '/site-refresh.js?v=1.88', "index refresh"), ('研究笔记总索引 · v1.87 · 2026-09-02', '研究笔记总索引 · v1.88 · 2026-09-03', "index footer"),
    ):
        page = replace_once_or_present(page, old, new, label)
    entry = '''          <li class="note-entry" data-note="r0-74s"><article><div class="entry-copy"><p class="note-code">R0.74S</p><h3>canonical best-N last-exit 等价与 no-gain</h3></div><nav class="entry-files" aria-label="R0.74S files"><a class="file-link html" href="/notes/r0-74s.html" aria-label="Read R0.74S HTML">HTML</a><a class="file-link pdf" href="/notes/r0-74s.pdf" aria-label="Download R0.74S PDF">PDF</a></nav></article></li>\n'''

...
test("retains R0.71V artifacts while v1.17 publishes R0.72D as current", async () => {
  ...
  assert.match(
    home,
    /<details class="tree-notes" open>[\s\S]*?aria-label="R0\.69P–R0\.72D"/,
  );
  assert.match(home, /href="#r070a">R0\.70A–R0\.72D 已公开并封存版本<\/a>/);

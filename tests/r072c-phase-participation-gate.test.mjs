...
test("retains the R0.72C note and recap after the homepage advances to R0.72H", async () => {
...
test("keeps the current manifest and refresh contract synchronized after R0.72H", async () => {

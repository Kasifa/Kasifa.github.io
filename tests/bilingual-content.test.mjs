...
test("English prose keeps the voice of one human researcher", async () => {
  ...
  assert.equal(
    dictionary[
      "资料截止：2026-08-30。若后续论文状态、版本或官方判断发生变化，我会在此页更新并保留原来的证据标签。"
    ],
    "Sources checked through 2026-08-30. If publication status, versions, or official assessments change, I will update this page while preserving the original evidence labels.",
  );
  assert.match(
    dictionary[

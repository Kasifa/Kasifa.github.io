...
const baseUrl = new URL(process.env.R076J_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R076J_DEPLOYED_COMMIT ?? "unversioned";
...
const objects = [
  ...
  ["public/recap-r0-61-r0-75w.html", "/recap-r0-61-r0-75w.html"], ["public/recap-r0-61-r0-75w.pdf", "/recap-r0-61-r0-75w.pdf"],
...
console.log(JSON.stringify({ status: failures.length === 0 ? "PASS" : "FAIL", release: "R0.76J Step 61", baseUrl: baseUrl.href, commit, objectCount: results.length, exactCount: results.length - failures.length, results, failures }, null, 2));

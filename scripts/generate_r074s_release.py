...
RELEASE = "r074s"
CODE = "R0.74S"
TITLE = "R0.74S｜终端公共窗口与条件 Morrey packing"
...
<title>{TITLE}</title><meta name="description" content="终端公共窗口精确归约；Morrey packing 在附加统一假设下闭合，universal window 与 ancestor gates 仍开放">
...
<body><nav class="top"><a href="/research-review.html">研究首页</a><span>R0.74S · 2026-09-03</span></nav><main><header class="hero"><div class="hero-inner"><div><div class="section-no">研究笔记 R0.74S · 完整中文版本</div><h1>{TITLE}</h1><p>short branch 已归约为连续的共同终端窗；selected-excess branch 在统一 critical Morrey 与 path-length 假设下闭合。<strong>S.280 / S.288 / S.303 仍 OPEN. NOT CLAY.</strong></p><div class="labels"><span class="label">PROVED REDUCTION</span><span class="label">CONDITIONAL MORREY</span><span class="label">WINDOW GATE OPEN</span><span class="label">ANCESTOR GATE OPEN</span><span class="label">NO-GO</span><span class="label">NOT CLAY</span></div></div><div class="stamp"><strong>状态 · R0.74S STEP 12</strong><p>S.273–S.306：PROVED / OPEN 分列</p><p>terminal window：EXACT REDUCTION</p><p>layer cake：EXACT</p><p>averaged endpoint：P^(4/5)</p><p>Morrey packing：CONDITIONAL</p><p>S.280：OPEN</p><p>S.288：OPEN</p><p>S.303：OPEN</p><p>regularity：OPEN</p><p>无仿真 / NO DGX</p></div></div></header><article>
{report_body()}
<section id="figure"><div class="section-no">F / 历史结构图</div><h2>Step 10 已付分支删除与 residual gate</h2><picture><source srcset="/assets/r074s/{FIGURE_ID}.svg" type="image/svg+xml"><img src="/assets/r074s/{FIGURE_ID}.png" alt="R0.74S Step 10 paid-branch deletion and residual gate"></picture><p><a href="/assets/r074s/{FIGURE_ID}.pdf">矢量 PDF</a> · <a href="/assets/r074s/{FIGURE_ID}.png">600 dpi PNG</a> · <a href="/assets/r074s/{FIGURE_ID}.svg">SVG</a> · <a href="/figures/r074s/{FIGURE_ID}/source-data.csv">source data</a> · <a href="/figures/r074s/{FIGURE_ID}/qa-report.md">视觉 QA</a></p><p class="note">这是 Step 10 的继承结构图，不是 Step 12 的数值结果。Step 12 是解析归约与 conditional theorem，没有伪造新图或新数据。</p></section>
<section id="reproduce"><div class="section-no">R / 冻结证据</div><h2>Step 12 主文、证书与独立审计</h2><p class="files"><a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_terminal_window_morrey_packing.md">Step 12 最终解析主文</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_terminal_window_morrey_primary_audit.md">Step 12 主审计</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_terminal_window_morrey_independent_audit.md">Step 12 独立审计</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_terminal_window_morrey_certificate.json">Step 12 机器证书 JSON</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_terminal_window_morrey_certificate_report.md">Step 12 证书报告</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_claim_state_update.md">主张边界</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_literature_boundary.md">文献边界</a> · <a href="https://github.com/Kasifa/Kasifa.github.io/blob/main/research/r074s_report-source.md">中文 reader source</a></p><p><a href="/notes/r0-74s.pdf">同步研究笔记 PDF</a> · <a href="/recap-r0-61-r0-74o.html">上一大里程碑 recap（截止 R0.74O，157 节）</a> · <a href="/recap-r0-61-r0-74o.pdf">PDF</a></p><p class="note">Step 12：Python 16/16 exact、12/12 finite、51/51 structural、11/11 mutations；Ruby 12/12 groups、153,237 exact cases、6/6 artifact locks、6/6 dependency locks、39/39 note checks。有限证书不替代 analytic proof。</p></section>
<section id="next"><div class="section-no">NEXT / 下一门槛</div><h2 style="margin:.35rem 0 .15rem;font-size:1.15rem">R0.74T</h2><p style="margin:.15rem 0">分别证明或反驳 common-window gate S.280 与 ancestor gate S.288，再检验 combined target S.303；不得把 conditional Morrey theorem 写成 bare suitable-weak theorem。</p></section></article></main></body></html>'''
...
def update_home() -> None:
    ...
    pairs = (
        ('data-site-version="1.90"', 'data-site-version="1.91"', "home version"),
        ('/i18n-en.js?v=1.90', '/i18n-en.js?v=1.91', "home i18n"),
        ('/site-refresh.js?v=1.90.1', '/site-refresh.js?v=1.91.1', "home refresh"),
        ('<strong>v1.90</strong>网页版本', '<strong>v1.91</strong>网页版本', "home stat version"),
        ('<h3>R0.74S：共享 best-N budget 与 terminal trace 障碍</h3>', '<h3>R0.74S：终端公共窗口与 conditional Morrey packing</h3>', "current route title"),
        ('<p class="tree-current-summary">共享 budget 的 infimal convolution 已精确闭合；short branch 的 terminal trace 与 scalar-excess uniform packing 仍开放。现有 multi-packet exact families 不否定 fixed positive N。NOT CLAY。</p>', '<p class="tree-current-summary">short branch 已归约为连续的 common terminal window；excess branch 在统一 critical Morrey/path-length 假设下闭合。S.280、S.288、S.303 仍 OPEN。NOT CLAY。</p>', "current route summary"),
        ('<p class="tree-path">shared infimal convolution → inverse-duration / nested tent → terminal trace boundary → selected-excess packing</p>', '<p class="tree-path">common terminal window → all-threshold layer cake → conditional moving-tube Morrey → universal gates remain open</p>', "current route path"),
        ('综述 v1.90 · 2026-09-03', '综述 v1.91 · 2026-09-03', "footer"),
    )
    for old, new, label in pairs:
        page = replace_once_or_present(page, old, new, label)
    page, count = re.subn(r'<div class="summary-item"><strong>我目前关注</strong><span>.*?</span></div>', '<div class="summary-item"><strong>我目前关注</strong><span>R0.74S Step 12 已把 short branch 归约为 common-window gate S.280，并在额外统一 Morrey/path 假设下闭合 excess packing；bare class 的 S.280、S.288、S.303 仍 OPEN。</span></div>', page, count=1, flags=re.S)
    if count != 1:
        raise RuntimeError("home focus replacement failed")
    latest = '''<section class="route-overview latest-release-spotlight" id="latest-release" aria-labelledby="latest-release-title"><div class="route-overview-inner"><header class="route-map-header"><div><p class="eyebrow">LATEST RELEASE · R0.74S · 2026-09-03</p><h2 class="route-map-title" id="latest-release-title">R0.74S｜终端公共窗口与条件 Morrey packing</h2><p class="route-map-intro">终端窗归约已闭合；Morrey packing 仅在附加统一假设下成立，universal gates 仍 OPEN。NOT CLAY.</p></div><nav class="route-map-actions" aria-label="最新发布快捷入口"><a class="route-map-latest" href="/notes/r0-74s.pdf">阅读最新 R0.74S 研究笔记 →</a><a href="/assets/r074s/fig-r074s-ball-clock-debt.pdf">Step 10 历史结构图</a><a href="/recap-r0-61-r0-74o.html">最新大里程碑 recap（R0.61–R0.74O，157 节）</a><a href="/notes/">221 篇研究笔记总索引</a><a href="#r074s">查看首页 R0.74S 卡片</a></nav></header><div class="route-legend" aria-label="最新发布计数"><span><i class="route-legend-mark kept" aria-hidden="true"></i>R0.70A–R0.74S · 123 节已公开</span><span><i class="route-legend-mark kept" aria-hidden="true"></i>98 节完整封存</span><span><i class="route-legend-mark current" aria-hidden="true"></i>当前端点 R0.74S</span></div></div></section>'''
    ...
    page = replace_once_or_present(page, 'terminal-window convex packing / arbitrary-clock triage / no-exception no-go → shared budget → terminal trace / selected-excess packing</p>', 'terminal-window convex packing / arbitrary-clock triage / no-exception no-go → common window → conditional Morrey packing → universal gates open</p>', "path tail")
    card = '''          <div class="task-one" id="r074s" data-release="r074s" style="margin-top:2rem"><p class="eyebrow">研究笔记 R0.74S · 2026-09-03</p><h3>R0.74S｜终端公共窗口与条件 Morrey packing</h3><p>终端窗归约已闭合；Morrey packing 仅在附加统一假设下成立，S.280 / S.288 / S.303 仍 OPEN。NOT CLAY.</p><p><a href="/notes/r0-74s.html"><strong>阅读完整中文笔记 →</strong></a> · <a href="/notes/r0-74s.pdf">PDF</a> · <a href="/assets/r074s/fig-r074s-ball-clock-debt.pdf">Step 10 历史图</a></p></div>\n'''
...
def update_literature() -> None:
    ...
    for old, new, label in (
        ('data-site-version="1.90"', 'data-site-version="1.91"', "lit version"), ('/i18n-en.js?v=1.90', '/i18n-en.js?v=1.91', "lit i18n"), ('文献综述 v1.90 · 2026-09-03', '文献综述 v1.91 · 2026-09-03', "lit footer"),
    ):
        page = replace_once_or_present(page, old, new, label)
    old = '<div class="route-step kept"><header><b>R0.74S</b><strong>共享 best-N budget 与 terminal trace 障碍</strong></header><p>S.249 给出共享 budget 的 exact infimal convolution；S.253–S.259 给出 short inverse-duration、nested-tent 与 positive-depth 控制；S.262–S.265 给出 excess/residual 常数 1/5、3 与 nonuniform compactness。S.261、S.269、S.272 仍开放。<a href="/notes/r0-74s.html">研究笔记</a> <a href="#r074s-boundary">主张边界</a></p></div><div class="route-step pause"><header><b>开放接口 · R0.74T</b><strong>terminal trace / selected-excess packing</strong></header><p>分别证明或反驳 S.261 与 S.269，再以相加后的固定 budget 检验 S.272。</p></div>'
    new = '<div class="route-step kept"><header><b>R0.74S</b><strong>终端公共窗口与 conditional Morrey packing</strong></header><p>S.273–S.280 把 short trace 归约为连续 common-window / all-threshold gate；S.285–S.300 给出 honest budget sum、conditional moving-tube Morrey theorem 与 mixed-norm benchmark。S.280、S.288、S.303 仍开放。<a href="/notes/r0-74s.html">研究笔记</a> <a href="#r074s-boundary">主张边界</a></p></div><div class="route-step pause"><header><b>开放接口 · R0.74T</b><strong>universal window / ancestor packing</strong></header><p>分别证明或反驳 S.280 与 S.288，再检验 combined target S.303。</p></div>'
    page = replace_once_or_present(page, old, new, "literature route")
    boundary = '<h3 id="r074s-boundary">R0.74S 的文献与主张边界</h3><p>Step 12 把 short residual 写成 common terminal-window target，并在额外统一 critical Morrey/path-length 假设下证明 excess packing；不声称从 bare suitable-weak ledger 得到 universal theorem，也不声称 novelty 或 priority。</p><div class="boundary"><strong>R0.74S Step 12 公开边界</strong><p>PROVED：terminal-window reduction、continuity、best-N layer cake、averaged P^(4/5) method boundary、honest ancestor budget sum、conditional moving-tube Morrey theorem、mixed-norm benchmark、no-winding/occupation screen。ABSTRACT NO-GO：S.281 与 S.301 不是 NSE counterexamples。FINITE：Python 16/16 exact、12/12 finite、51/51 structural、11/11 mutations；Ruby 12/12 groups、153,237 cases、39/39 note checks。OPEN：S.280、S.288、S.303、S.272、Q.12、Q.1 与正则性。speed-only route 只被 kinematically screened，不是 universal PDE no-go。<strong>NOT CLAY.</strong> <a href="/notes/r0-74s.html">阅读完整中文笔记</a>。</p></div>\n'
...
def update_notes_index() -> None:
    ...
    for old, new, label in (
        ('data-site-version="1.90"', 'data-site-version="1.91"', "index version"), ('/i18n-en.js?v=1.90', '/i18n-en.js?v=1.91', "index i18n"), ('/site-refresh.js?v=1.90', '/site-refresh.js?v=1.91', "index refresh"), ('研究笔记总索引 · v1.90 · 2026-09-03', '研究笔记总索引 · v1.91 · 2026-09-03', "index footer"),
    ):
        page = replace_once_or_present(page, old, new, label)
    entry = '''          <li class="note-entry" data-note="r0-74s"><article><div class="entry-copy"><p class="note-code">R0.74S</p><h3>终端公共窗口与条件 Morrey packing</h3></div><nav class="entry-files" aria-label="R0.74S files"><a class="file-link html" href="/notes/r0-74s.html" aria-label="Read R0.74S HTML">HTML</a><a class="file-link pdf" href="/notes/r0-74s.pdf" aria-label="Download R0.74S PDF">PDF</a></nav></article></li>\n'''

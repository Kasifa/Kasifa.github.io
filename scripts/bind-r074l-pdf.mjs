...
// Render and bind the complete Chinese R0.74L note. This certifies publication
...
const release = "r074l";
const noteSlug = "r0-74l";
const title = "R0.74L｜变化的桥族、短时钟，和一个闭合的主领圈";
...
try {
  ...
  if (structure.title !== title) throw new Error("R0.74L PDF title drift");
  ...
  ) throw new Error("R0.74L render provenance mismatch");

  const binding = {
    schemaVersion: "r074l-synchronized-pdf-binding-v1",
    release: "R0.74L",

...
test("retains the corrected R0.71T release after the R0.72J site update", async () => {
  ...
  assert.ok(home.includes('src="/i18n-en.js?v=1.23"'));
  assert.ok(literature.includes('src="/i18n-en.js?v=1.23"'));

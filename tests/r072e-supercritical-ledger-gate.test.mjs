...
test("retains R0.72E, its 95-node recap, and bilingual package after R0.72K", async () => {
  const [
    home,
    note,
    recap,
...
test("keeps the current R0.72O site version and split release inventory", async () => {

...
const baseUrl = new URL(process.env.R076G_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R076G_DEPLOYED_COMMIT ?? "unversioned";
const sha256 = (bytes) => createHash("sha256").update(bytes).digest("hex");

const objects = [
  ["public/notes/r0-76g.html", "/notes/r0-76g.html"],
  ["public/notes/r0-76g.pdf", "/notes/r0-76g.pdf"],

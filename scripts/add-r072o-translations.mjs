...
const englishByChinese = new Map([
  ...
  ["R0.70A–R0.72O 共 67 个版本已公开；43 个按当前 formal-figure 合同完整封存，24 个旧版附图档案仍列入回补清单。", "A total of 67 releases from R0.70A through R0.72O are public; 43 are fully archived under the current formal-figure contract, while 24 legacy figure packages remain on the backfill list."],

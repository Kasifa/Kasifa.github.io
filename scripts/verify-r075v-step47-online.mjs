...
const baseUrl = new URL(process.env.R075V_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R075V_DEPLOYED_COMMIT ?? "unversioned";
const sha256 = (bytes) => createHash("sha256").update(bytes).digest("hex");

const objects = [
  ["public/notes/r0-75v.html", "/notes/r0-75v.html"],
  ["public/notes/r0-75v.pdf", "/notes/r0-75v.pdf"],
  ["public/recap-r0-61-r0-75v.html", "/recap-r0-61-r0-75v.html"],
  ["public/recap-r0-61-r0-75v.pdf", "/recap-r0-61-r0-75v.pdf"],

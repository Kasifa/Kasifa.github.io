...
const output = process.argv[3] ?? "/private/tmp/r074o-browser-qa";
await mkdir(output, { recursive: true });

const browser = await chromium.launch({ executablePath, headless: true });
const cases = [
  { id: "note-zh-desktop", path: "/notes/r0-74o.html?lang=zh", width: 1440, height: 1000, lang: "zh" },
  { id: "note-en-desktop", path: "/notes/r0-74o.html?lang=en", width: 1440, height: 1000, lang: "en" },
  { id: "note-zh-mobile", path: "/notes/r0-74o.html?lang=zh", width: 390, height: 844, lang: "zh" },
  { id: "note-en-mobile", path: "/notes/r0-74o.html?lang=en", width: 390, height: 844, lang: "en" },
  { id: "recap-zh-desktop", path: "/recap-r0-61-r0-74o.html?lang=zh", width: 1440, height: 1000, lang: "zh" },
  { id: "recap-en-desktop", path: "/recap-r0-61-r0-74o.html?lang=en", width: 1440, height: 1000, lang: "en" },
  { id: "recap-zh-mobile", path: "/recap-r0-61-r0-74o.html?lang=zh", width: 390, height: 844, lang: "zh" },
  { id: "recap-en-mobile", path: "/recap-r0-61-r0-74o.html?lang=en", width: 390, height: 844, lang: "en" },
  { id: "home-zh-desktop", path: "/research-review.html?lang=zh#r074o", width: 1440, height: 1000, lang: "zh" },
  { id: "home-en-mobile", path: "/research-review.html?lang=en#r074o", width: 390, height: 844, lang: "en" },
];
const results = [];
try {
  for (const item of cases) {
    ...
    const state = await page.evaluate(({ expectedLang, isNote }) => {
      ...
      const card = document.querySelector('[data-release="r074o"]');
      return {
        ...
        noDissipationLowerBoundVisible: /no (?:separate )?matching (?:dissipation )?lower bound|没有(?:证明)?匹配(?:耗散)?下界/i.test(body) || !isNote,
...
const report = { schemaVersion: "r074o-browser-qa-v1", base, output, cases: results, allPass: results.every((item) => item.pass) };

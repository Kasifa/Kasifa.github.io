...
// Render and bind the complete Chinese R0.74I note. This certifies publication
...
const release = "r074i";
const noteSlug = "r0-74i";
const title = "R0.74I｜适合弱解的移动管门与平方根对数支付边界";
...
try {
  ...
  if (structure.title !== title) throw new Error("R0.74I PDF title drift");
  ...
  ) throw new Error("R0.74I render provenance mismatch");

  const binding = {
    schemaVersion: "r074i-synchronized-pdf-binding-v1",
    release: "R0.74I",

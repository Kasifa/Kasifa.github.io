...
test("the public transaction assembles the complete target in memory without applying", () => {
  ...
  assert.equal(result.figureMetadataInputCommit, "478674623bbbd9c9953c13048fd3455644736084");
  assert.equal(result.figureMetadataCommit, "8f425d85a614b3d307715b4bf4f5daa5fff23693");
  assert.equal(result.sourceMetadataInputCommit, "478674623bbbd9c9953c13048fd3455644736084");

...
test("retains R0.71V artifacts while v1.20 publishes R0.72G as current", async () => {
  ...
  assert.match(
    home,
    /<details class="tree-notes" open>[\s\S]*?aria-label="R0\.69P–R0\.72G"/,
  );
  assert.match(home, /href="#r070a">R0\.70A–R0\.72G：59 节已公开，35 节完整封存<\/a>/);

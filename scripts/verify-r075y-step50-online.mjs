...
const baseUrl = new URL(process.env.R075Y_PUBLIC_BASE_URL ?? "https://kasifa.github.io/");
const commit = process.env.R075Y_DEPLOYED_COMMIT ?? "unversioned";
const sha256 = (bytes) => createHash("sha256").update(bytes).digest("hex");

const objects = [
  ["public/notes/r0-75y.html", "/notes/r0-75y.html"],
  ["public/notes/r0-75y.pdf", "/notes/r0-75y.pdf"],
